...
Serial.println("getLine does something. LINE 130 ");

// UNIVERSAL USE ###bookmark
//  34   if (!fatfs.exists(WORKING_DIR)) {

      if (fatfs.exists(SPI_FlashROM_FILENAME)) {
Serial.println("getLine does something. LINE 137 - - - - - ");
          if (fileClosed) {
